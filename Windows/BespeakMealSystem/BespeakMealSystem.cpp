// BespeakMealSystem.cpp : 定义应用程序的入口点。
//
...
public:
	...
	void Init() {
		...
		m_pForumBtn = static_cast<CButtonUI*>(m_pm.FindControl(_T("forumbtn")));
	}
	...
	void Notify(TNotifyUI& msg)
	{
		if (msg.sType == _T("windowinit")) OnPrepare();
			...
			else if (msg.pSender == m_pForumBtn) {
				//点击论坛
				ShellExecute(this->m_hWnd, _T("open"), _T("http://10.10.0.2/dzbbs/forum.php?mod=forumdisplay&fid=14"), _T(""), _T(""), SW_SHOW);
			}
		}
